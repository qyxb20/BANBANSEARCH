...
//  ByqIOSApps
//
//  Created by MrChen on 2022/7/14.
//  Copyright © 2022 MrChen_CWJ. All rights reserved.
//
...
- (void)defalutInit{
    ...
    _titleView.backgroundColor = [UIColor colorWithRed:187./255.
                                                 green:19./255.
                                                  blue:41./255.
                                                 alpha:1.0f];
...
- (void)dismiss{
    if (self.selectDelegate) {
        if ([[_titleView text] isEqual:@"営業時間の選択"]) {
            [self.selectDelegate itemSelected:self SelectedItem:@"00:00~23:59"];
        }
        else{
